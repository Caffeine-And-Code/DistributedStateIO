...
To create a lobby and start a match, a minimum of **3 players** and a maximum of **8 players** are required.

The first player to join a lobby (therefore creating it) is designated as the **Lobby Master** and is allowed to modify the **reconnection logic**.  
...
The Lobby Master can choose one of the following behaviors while waiting for the inactive player to reconnect:
...
As a result, the game map will contain between **3 and 8 owned territories**, while the remaining ones are considered **neutral territories**.
